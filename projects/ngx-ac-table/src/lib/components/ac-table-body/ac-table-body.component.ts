import {AfterViewInit, Component, DestroyRef, ElementRef, Host, HostBinding, HostListener, Inject, Input, Optional, QueryList, TemplateRef, ViewChildren} from '@angular/core';
...
export class AcTableBodyComponent implements AfterViewInit {
    ...
    constructor(@Optional() @Host() @Inject(AC_TABLE_COMPONENT) public acTableComponent: IAcTableComponent,
